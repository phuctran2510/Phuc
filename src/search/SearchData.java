...
public class SearchData{
    ...
    public ArrayList<Article> getArticles(String search, String section, String subsection, String author, String tagSub, String tagOrg, String tagPer, String tagLoc) throws IOException {
    	...
    	File f = new File("C:\\Users\\PHUCTRAN\\eclipse-workspace\\Phuc\\Ontology\\populated.owl");
		...
		String queryString =
			...
			"PREFIX on: <http://www.semanticweb.org/phuc/ontologies/2018/06/WS_Project#> " +
    ...
    public ArrayList<Article> getRecommendation() throws IOException {
    	...
    	BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\PHUCTRAN\\eclipse-workspace\\Phuc\\src\\recommendation.txt"));
    	section = br.readLine();
    	// No Sections
		if (section == null) {
    ...
    public void addToHistory(String section) {
    	try {
		    String filename= "C:\\Users\\PHUCTRAN\\eclipse-workspace\\Phuc\\src\\recommendation.txt";
