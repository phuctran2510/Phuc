<html>
	...
	<body>
		<%@page import="search.*,entities.*,java.util.ArrayList" pageEncoding="UTF-8"%>
		<%
		    SearchData bean = new SearchData();
		...
		<header>
			<div class="header-right" >
				<form action="index.jsp" method="GET">
								<font size="2">Học Viên : Trần Vĩnh Phúc</font>
				<a href="index.jsp" style="margin-left: 200px;"><span style="color: white; background-color: blue">Ứng Dụng Semantic Web Trong Tìm Kiếm Bài Báo Trên Trang VnExpress.net</span></a>
									<input type="text" name="search" width="10" placeholder="Search" >
					<input type="submit" value="Search" width="10">
				</form>
			</div>
				...
				<form class="topics" name="topicNY" action="index.jsp" method="GET">
					...
					<form class="topics" name="topicArts" action="index.jsp" method="GET">
					    <a id="topicArts">
					      ...
					      <span style="color: white; background-color: blue"><font size = "4.5" > <strong>   Arts</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicBusiness" action="index.jsp" method="GET">
					    <a id="topicBusiness">
					      ...
					      <span style="color: white; background-color: blue"><font size = "4.5"> <strong>   Business</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicFashion" action="index.jsp" method="GET">
					    <a id="topicFashion">
					     ...
					     <span style="color: white; background-color: blue"><font size = "4.5"> <strong>    Fashion</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicFood" action="index.jsp" method="GET">
					    <a id="topicFood">
					        <input type="text" name="section" style="display:none" value="Food">
					      <span style="color: white; background-color: blue"><font size = "4.5"> <strong>   Food</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicHealth" action="index.jsp" method="GET">
					    <a id="topicHealth">
					      ...
					      <span style="color: white; background-color: blue"><font size = "4.5"> <strong>Health</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicMagazine" action="index.jsp" method="GET">
					    <a id="topicMagazine">
					        ...
					        <span style="color: white; background-color: blue"><font size = "4.5"> <strong> Magazine</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicMovies" action="index.jsp" method="GET">
					    <a id="topicMovies">
					     ...
					     <span style="color: white; background-color: blue"><font size = "4.5"> <strong>    Movies</strong> </font></span>
					    </a>
					</form>
					...
					<form class="topics" name="topicReal" action="index.jsp" method="GET">
					    <a id="topicReal">
					       ...
					       <span style="color: white; background-color: blue"><font size = "4.5"> <strong>  Real Estate</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicSports" action="index.jsp" method="GET">
					    <a id="topicSports">
					       ...
					       <span style="color: white; background-color: blue"><font size = "4.5"> <strong>  Sports</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicTechnology" action="index.jsp" method="GET">
					    <a id="topicTechnology">
					       ...
					       <span style="color: white; background-color: blue"><font size = "4.5"> <strong>  Technology</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicTravel" action="index.jsp" method="GET">
					    <a id="topicTravel">
					      ...
					      <span style="color: white; background-color: blue"><font size = "4.5"> <strong>   Travel</strong> </font></span>
					    </a>
					</form>
					<form class="topics" name="topicWorld" action="index.jsp" method="GET">
					    <a id="topicWorld">
					        <input type="text" name="section" style="display:none" value="World">
					       <span style="color: white; background-color: blue"><font size = "4.5"> <strong>  World</strong> </font></span>
					    </a>
					</form>
